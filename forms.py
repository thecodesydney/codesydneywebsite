...
class VueInputForm(Form):
    ...
    B1 = SelectField('Day 1: (JavaScript 30) JavaScript Drum Kit', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B2 = SelectField('Day 2: (JavaScript 30) CSS + JS Clock', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B3 = SelectField('Day 3: (JavaScript 30) Playing with CSS Variables and JS', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B4 = SelectField('Day 4: (JavaScript 30) Array Cardio Day 1', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B5 = SelectField('Day 5: (JavaScript 30) Flex Panels Image Gallery', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B6 = SelectField('Day 6: (JavaScript 30) AJAX Type Ahead', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B7 = SelectField('Day 7: (JavaScript 30) Array Cardio Day 2', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B8 = SelectField('Day 8: (JavaScript 30) Fun with HTML5 Canvas', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B9 = SelectField('Day 9: (JavaScript 30) 14 Must Know Dev Tool Tricks', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B10 = SelectField('Day 10: (JavaScript 30) Hold Shift to check multiple checkboxes', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B11 = SelectField('Day 11: (JavaScript 30) Custom HTML5 Video Player', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B12 = SelectField('Day 12: (JavaScript 30) Key Sequence Detection (Konami Code)', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B13 = SelectField('Day 13: (JavaScript 30) Slide in on scroll', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B14 = SelectField('Day 14: (JavaScript 30) Objects and Arrays - Reference vs Copy', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B15 = SelectField('Day 15: (JavaScript 30) Localstorage and Event Delegation', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B16 = SelectField('Day 16: (JavaScript 30) CSS Text Shadow mouse move effect', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B17 = SelectField('Day 17: (JavaScript 30) Sorting band names without articles', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B18 = SelectField('Day 18: (JavaScript 30) Tally string times with reduce', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B19 = SelectField('Day 19: (JavaScript 30) Unreal webcam fun', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B20 = SelectField('Day 20: (JavaScript 30) Native speech recognition', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B21 = SelectField('Day 21: (JavaScript 30) Geolocation based Speedometer and Compass', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B22 = SelectField('Day 22: (JavaScript 30) Follow along links', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B23 = SelectField('Day 23: (JavaScript 30) Speech synthesis', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B24 = SelectField('Day 24: (JavaScript 30) Sticky Nav', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B25 = SelectField('Day 25: (JavaScript 30) Event capture, propagation, bubbling and once', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B26 = SelectField('Day 26: (JavaScript 30) Stripe follow along dropdown', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B27 = SelectField('Day 27: (JavaScript 30) Click and drag to scroll', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B28 = SelectField('Day 28: (JavaScript 30) Video speed controller UI', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B29 = SelectField('Day 29: (JavaScript 30) Countdown clock', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
    B30 = SelectField('Day 30: (JavaScript 30) Whack a mole game', choices=[('Not yet started','Not yet started'),('In progress','In progress'),('Completed','Completed')])
